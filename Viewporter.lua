-- Original source code: https://www.curseforge.com/wow/addons/viewporter
-- Original author: Peter SZTANOJEV <sztanpet@gmail.com>
-- The original addon is release with 'Public Domain' license.
-- This addon is updated by RMLR keep it functioning.
...
function self:onLoad( event, name )
  ...
  -- Taken from CTMod during the 8.3.0.10 'fix mid-combat cinematics'
